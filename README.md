...
- Deployed on Vercel, hourly cron marks no shows
...
5. The cron in `vercel.json` calls `/api/cron/sweep` every hour to mark overdue bookings as no shows. Admin can also run it from the overview page.
